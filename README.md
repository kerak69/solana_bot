...
Cкип меньше или  равен среднему по кластеру плюс уставка указанная в skip_dop (установил 15, можно менять), то возле skip будет зеленый кружок и процент скипа, если скип превысит этот параметр то  кружок станет карссным;
...
**В палнах седлать так, чтобы можно было  одновременно контролировать и майнет и тестнет ноды** 
